...
- `PYTHON_SOLVER_URL` — full URL of the Python solver project (separate Vercel project rooted at `solver/`), e.g. `https://truco-solver.vercel.app/api/solver`. Required in production.
